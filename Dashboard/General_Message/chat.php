...
<?php
  ...
  $connection_user = mysqli_connect($host,$user,$password,$database_user);
  ...
  while($row = $run->fetch_array()) :
    ...
    $username = $row["Sender"];
    $users_last_name = $row['sender_last'];
  	$profile_pic_query = "SELECT * FROM tbl_login WHERE First_Name = '$username' AND Middle_Name = '$users_last_name'";
  	$execute_command_query = mysqli_query($connection_user,$profile_pic_query);
