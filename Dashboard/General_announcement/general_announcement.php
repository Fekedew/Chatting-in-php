...
$connection_user = mysqli_connect($host, $user, "", $database2);
...
$execute_update_profile_query = mysqli_query($connection_user,$update_profile_query);
...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            <li><a href="../../../user.php"><img src="../img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Home</span></a></li>
...
<!-- 
  ...
  $connection_String = mysqli_connect($host,$user,$pass,$database);
    ...
    $message_title = mysqli_real_escape_string($connection_String, $_POST["title"]);
    $message_body = mysqli_real_escape_string($connection_String, $_POST["message"]);
    ...
    if($message_title!=""&& $message_body!=""){
      ...
      $execute_insert_query = mysqli_query($connection_String,$insert_query_command) or die($connection_String);
    }
