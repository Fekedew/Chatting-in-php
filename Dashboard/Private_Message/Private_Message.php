...
<head>
    ...
    <title>Wolkite University CCI Office Work flow</title>
...
<span style="margin-top:3px"><strong><?php echo ($_COOKIE["user_first_name"].' '.$_COOKIE["users_last_name"]); ?></strong></span>
</div>
</div>
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            session_start();
              ...
              if($user_type == 'user'){
                echo '<li><a href="../../../user.php"><img src="../img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Home</span></a></li>';
              }else{
                echo '<li><a href="../../../ADMINN.php"><img src="../img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Home</span></a></li>';
              }
            ?>
...
<!--             <li><a href="../General_Share/General_Share.php"><img src="../img/businessman.png" class="navimg img-responsive" /><span class="nav-writting">Public Share</span></a></li>
            ...
            <li onclick="Logout()"><a href="../../../logout.php"><img src="../img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Logout</span></a></li>
        </ul>
    </div>
  ...
  <?php
        ...
        $connection_String = mysqli_connect($host,$user,$pass,"owas");
        $myfiles = $_FILES["file"]["name"];
        $update_profile_query = "UPDATE tbl_login SET Profile_Picture = '$myfiles' WHERE First_Name ='$selected_username' AND Middle_Name ='$users_last_name'";
...
<script src="../js/jquery-3.1.1.min.js"></script>
 ...
 <script src="../js/jquery.yacal.min.js"></script>
  ...
  setInterval(function(){
      $("#Get_Online_Users").load("Online_Users2.php"); // Add s to the #Get_Online_User to start ajax requests
    },1000);
  }
  });
