...
<a href="#" class="header_text"><p id="header-text" class="text-muted">send<span style="color:blue">CHat</span><span style="padding-left: 350px; color: blue;"> <u>at cci office work flow</u></span></p></a>
</span>
</div>
        ...
        <ul class="lists"> 
          <?php
            ...
            if($user_type == 'administrator'){
              echo '<li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="../../ADMINN.php"><img src="img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Home</span></a></li>';
            }else{
              echo '<li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="../../user.php"><img src="img/dashboard.png" class="navimg img-responsive"/><span class="nav-writting">Home</span></a></li>';
            }
          ?>
